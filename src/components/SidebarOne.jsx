...
function SidebarOne({ open, setOpen }) {
  ...
  return (
    <div className="md:hidden">
      ...
      ></div>
      <div className={`fixed left-0 inset-y-0 bg-white text-black z-30 transition-transform duration-500 ease w-60
      ${open ? 'block translate-x-0' : 'hidden -translate-x-[200%]'}`}>
